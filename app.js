...
<<<<<<< HEAD
  ...
  var workoutOptions = [];
  var message10Min = 'Perform one set of each exercise to complete a circuit. Complete two circuits total to finish the workout. Your rest between exercises should be only as long as it takes to transition to the next exercise.';
  var message20Min = 'Perform one set of each of the six exercises to complete a circuit. Complete two circuits total to finish the workout. Your rest between exercises should be only as long as it takes to transition to the next exercise.';
...
>>>>>>> secondary_master
  ...
  function pickTotalBody(){
    for (var i = 0; i < 3; i++){
      ...
      generatedWorkout.push(totalBody[randoNum]); //this could duplicate exercises
    }
  }
  ...
  var plank = new MakeWorkout('Plank', 'Core', 'Intermediate', false, false, 'core', 'https://www.youtube.com/embed/pSHjTRCQxIw', 'This static exercise works just about every muscle in the body, and helps to sculpt the core. Try 30 seconds per set if you\'re a beginner, or 1 minute for more advanced atheltes.');
...
<<<<<<< HEAD
  ...
  var totalBody = [burpee, bearcrawl, mountainClimber, jumpingJack, spidermanPushup, kbellSwing, thrusters, snatch];
