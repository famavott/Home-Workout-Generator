...
var halo = new MakeWorkout('Halo', 'Total', 'Intermediate', true, false, 'Total', 'https://www.youtube.com/embed/Zy6bgAxPeks', 'While holding onto a kettlebell with both hands, move it around your head while stabilizing your core.');
...
var lungWOP = new MakeWorkout('Lunge + overhead press', 'Total', 'Advanced', true, false, 'Total', 'https://www.youtube.com/embed/E5_YxmOyjiE', 'Hold weights at your sholders, lunge, then press the the weights above your head.');
var renegade = new MakeWorkout('Renegade Row', 'Total', 'Advanced', true, false, 'Total', 'https://www.youtube.com/embed/PJpTBj4ilZw', 'While in a raised push-up position, row the individual weights while stabilizing your core.');
var figure8 = new MakeWorkout('Figure Eight', 'Total', 'Intermediate', true, false, 'Total', 'https://www.youtube.com/embed/xpHWMC2_e3c', 'Move kettlebell between legs in figure eight pattern, alternating the hand that holds it.');
